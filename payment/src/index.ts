...
(async () => {
    ...
    if (!process.env.MONGO_URI || !process.env.JWT_SECRET || !process.env.PAYMENT_SERVICE_PORT
        || !process.env.KAFKA_BROKER || !process.env.RAZORPAY_KEY_ID || !process.env.RAZORPAY_KEY_SECRET
    ) {
